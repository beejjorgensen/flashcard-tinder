...
const authRoutes = require('./api/vroutes/auth-routes');
const profileRoutes = require('./api/vroutes/profile-routes');
const passportSetup = require('./api/vconfig/passport-setup');
const mongoose = require('mongoose');
const keys = require('./api/vconfig/keys');
const cookieSession = require('cookie-session');
const passport = require('passport');
const bodyParser = require('body-parser');
const Card = require('./api/vmodels/card-model.js');
